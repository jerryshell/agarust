...
func _add_entry(player_name: String, score: int, highlight: bool) -> void:
...
func remove(player_name: String) -> void:
...
func set_score(player_name: String, score: int, highlight: bool = false) -> void:
	remove(player_name)
	_add_entry(player_name, score, highlight)
